...
async def generate_production_step(request: Request):
    ...
    try:
        ...
        def rounded_rect_solid(w: float, h: float, r: float, length: float):
            ...
            CadQuery 2.8 ondersteunt fillet2D niet op Workplane; gebruik daarom
            Sketch.fillet. Dit voorkomt de oude fallback naar scherpe hoeken.
            """
        ...
        for length in lengths:
            ...
            # Workplane.cut kan intern een Compound teruggeven, zelfs als die
            # maar één Solid bevat. Assembly.add/export probeert daar in deze
            # situatie tuples/locations van te maken en veroorzaakt:
            # "compound: 0 methods found (... tuple ...)".
            #
            # Daarom halen we hier expliciet de echte OCC-solids uit ieder
            # resultaat en bouwen daarna één valide CadQuery Compound.
            value = tube.val()
