...
def _storage_config_from_payload(payload_json: str) -> dict:
    try:
        ...
        payload = {}
    cfg = payload.get("storage_config") if isinstance(payload, dict) else None
...
def _configured_subfolder(payload_json: str, filename: str) -> str:
    ...
    elif suffix in {".zx", ".nest"}: key = "sourceFolder"
    else: key = "otherFolder"
