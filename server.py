...
STEP_MATERIAL_LENGTH_VERSION = 6  # longest physical main-wall side; cache forced refresh
...
def _assembly_cache_path(job_id: str) -> Path:
    return CACHE_DIR / job_id / "assembly_mesh_physical_cut_v65_main_wall_length_v6.json"
